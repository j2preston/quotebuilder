...
import {
  ...
  ExternalLink, Plus, Pencil, X, Check,
} from 'lucide-react';
import {
  ...
  const submitCalibration = () => {
    if (pendingQty !== null) {
      logCorrection.mutate({
        quoteId, jobKey: jobKey ?? 'unknown', field: 'labour_hours',
        oldValue: item.qty, newValue: pendingQty, reason: calibReason,
      });
